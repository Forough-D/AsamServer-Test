      ...
      <div class="col-lg-8">
        <div class="row mt-4">
          ...
          <div class="col-xl-6">
            <div class="row">
              <div class="col-md-6">
                <default-info-card icon="text-white fas fa-landmark" title="Salary" description="Belong Interactive"
                  value="+$2000" />
              </div>
              <div class="col-md-6">
                <default-info-card icon="text-white fab fa-paypal" title="Paypal" description="Freelance Payment"
                  value="$455.00" />
              </div>
            </div>
          </div>
